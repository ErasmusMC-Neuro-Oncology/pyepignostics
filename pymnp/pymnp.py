...
class sample:
    ...
    def get_detailed_info(self, app):
        """DEPRECATED: Uses legacy molecularneuropathology.org API. Use get_workflow_runs_new() with Epignostix API instead."""
        warnings.warn("sample.get_detailed_info() is deprecated, use get_workflow_runs_new() with Epignostix API instead", DeprecationWarning, stacklevel=2)
        new_workflows = {}
    ...
    def remove(self, app):
        """DEPRECATED: Uses legacy molecularneuropathology.org API. Use Epignostix API instead."""
        warnings.warn("sample.remove() is deprecated, use Epignostix API instead", DeprecationWarning, stacklevel=2)
